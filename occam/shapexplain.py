...
from experiment_neural_nets import get_obfuscation_small_model_swish
...
def train_obfuscator_top_k_features(shap_data_dict, topk_size, x_train, x_test, util_labels, priv_e_labels,
    ...
    model_features_util = np.setdiff1d(model_features, util_shap_idxs[-5:])
    ...
    model = get_obfuscation_small_model_swish(nn_input_sz[1])
