...
from util.trim_insig_weights import *
...
num_of_w_org, num_of_nz_w_org, num_of_z_w_org = inspect_weigths('original (unpruned)', model_org)
unzippedh5_size_org, zippedh5_size_org = retrieve_size_of_model(model_org)
unzippedlt_size_org, zippedlt_size_org, tflite_model = retrieve_size_of_lite_model(model_org)

read_lite_model_weights_back(model_org)
# num_of_w_orgl, num_of_nz_w_orgl, num_of_z_w_orgl = inspect_weigths('Lite Default Optmized', tflite_model)
...
for ac in attempt_configs:
    ...
    num_of_w_pruned, num_of_nz_w_pruned, num_of_z_w_pruned = inspect_weigths(ac.name, model_pruned)
